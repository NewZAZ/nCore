package fr.newzproject.core.utils.compatibility;
...
public class CompatibleMessage {
    ...
    static {
        if (fr.newzproject.core.utils.compatibility.ServerVersion.isServerVersionAtOrBelow(fr.newzproject.core.utils.compatibility.ServerVersion.V1_8)) {
    ...
    public static void sendActionBar(Player player, String message) {
        if (fr.newzproject.core.utils.compatibility.ServerVersion.isServerVersionAtLeast(fr.newzproject.core.utils.compatibility.ServerVersion.V1_9)) {
    ...
    public static void sendTitle(Player player, String title, String subTitle) {
        if (fr.newzproject.core.utils.compatibility.ServerVersion.isServerVersionAtLeast(fr.newzproject.core.utils.compatibility.ServerVersion.V1_11)) {
